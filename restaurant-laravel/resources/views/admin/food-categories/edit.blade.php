    ...
    <div class="container-fluid  dashboard-content">
                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="/admin/food-categories" class="breadcrumb-link"> Food
                                        Categories</a></li>
        ...
        <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="/admin/food-categories/{{ $category->id }}" id="basicform"
                        ...
                        <div class="form-group">
                            ...
                            <input id="inputTitle" type="text"
                                ...
                                placeholder="Enter category name" value="{{ old('title', $category->title) }}" required
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="inputDescription" type="text"
                               ...
                               required placeholder="Write a description"
                                autofocus> {{ old('description', $category->description) }}</textarea>
                            @error('description')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
