                        ...
                        <div class="page-breadcrumb">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">@if (Auth::user()->isAdmin())
                                         Admin Dashboard 
                                         @else
                                         Employee Dashboard
                                    @endif
                            ...
                            <div class="card">
                                ...
                                <div class="card-footer">
                                    <p class="display-7 font-weight-bold"><span
                                            class="text-primary d-inline-block">Estimated
                                            Revenue Last 30 Days ฿{{ $estimated_income_last_30 }}</span><span
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td colspan="9"><a href="/admin/reservations"
                                                    class="btn btn-outline-dark float-left">View Details</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
