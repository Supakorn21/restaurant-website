...
Facades\View::composer(['home', 'pages.about', 'pages.contact', 'pages.offers', 'pages.reservations', 'thankyou-offers', 'pages.thankyou-reservations', 'menu.all-categories', 'menu.single-menu', 'layouts.admin', 'layouts.landing-page', 'layouts.app'], function (View $view) {
